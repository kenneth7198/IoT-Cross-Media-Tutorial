 ...
 * 
 * 硬體連接：
 * - LED 正極 → GPIO 23 → 220Ω電阻 → LED負極 → GND
 * - 按鈕(可選) → GPIO 22 → GND (用於本地測試)
 * 
 * JSON 格式範例：
 * {"led": 1}  // 開啟 LED
 * {"led": 0}  // 關閉 LED
 * {"led": 1, "brightness": 128}  // 未來可擴充 PWM 控制
 */
...
const char* TOPIC_LED_CONTROL = "sensor/LED";      // 訂閱主題：接收控制指令
const char* TOPIC_LED_STATUS = "status/led";       // 發布主題：回報LED狀態

// ========== 硬體腳位設定 ==========
const int LED_PIN = 23;
const int BUTTON_PIN = 22;  // 可選：用於本地測試
